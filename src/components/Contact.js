                ...
                <div className="content-main-dad" style={{margin: '0 auto'}}>
                    ...
                    <div className="max-w-sm overflow-hidden">
                        <div style={{textAlign: 'center'}} className="px-6 py-4">
                            ...
                            <a id="btn-contact" style={{position: 'relative', zIndex: 9999}} className="font-normal hover:text-white py-2 px-4" target="_blank" href="mailto:umanggarg28@gmail.com">Say Hello!</a>
                                <lottie-player
                                    hover
                                    loop
                                    mode="normal"
